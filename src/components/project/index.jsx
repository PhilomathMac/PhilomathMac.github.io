      ...
      >
        <div className="flex justify-between flex-col p-8 h-full w-full">
          <div>
            ...
            <div style={{width: "90%", height: "200px", objectFit: "cover", overflow:"hidden", borderRadius: "10px"}}>
              <img align="center" vspace="20" src={'https://raw.githubusercontent.com/PhilomathMac/'+item.name+'/main/PortfolioImage.png'} onError={i => i.target.parentElement.style.display='none'}>
              </img>
            </div>
